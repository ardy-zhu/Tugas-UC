...
<head>
    ...
    <title><?= htmlspecialchars($title ?? 'Pembelian') ?></title>
    <style>
        ...
        nav { background: #1e293b; padding: 14px 20px; border-radius: 10px; }
...
<body>
    <div class="container">
        ...
        <div class="card">
            ...
            <?php if (empty($items)): ?>
                <p>Belum ada data pembelian. Hubungkan ke tabel <strong>pembelian</strong> di database untuk menampilkan data.</p>
            <?php else: ?>
                <table>
                    <thead>
                        <tr>
